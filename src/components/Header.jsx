...
export default function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-charcoal/95 backdrop-blur-md border-b border-charcoalBorder">
      ...
      <div className="bg-[#0d0d0d] py-1 px-4 border-b border-charcoalBorder/50">
        <p className="text-center text-xs text-warmCream/90 font-medium tracking-tight">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 h-16 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 cursor-pointer">
          <img
            src="/logo-ahumados.png"
            alt="Logo Ahumados & Carbón"
            className="h-10 w-auto object-contain rounded-md"
            onError={(e) => {
              // Fallback si la extensión original fuera .jpg
          ...
          <div className="leading-tight">
            <span className="font-bold text-warmCream text-sm sm:text-base tracking-wide block">
              AHUMADOS & CARBÓN
            </span>
        ...
        <div className="bg-[#0f0f0f] p-1 rounded-full border border-charcoalBorder flex items-center">
          <button
            ...
            className={`px-3 sm:px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold transition-all duration-200 flex items-center gap-1.5 ${
              currentMode === 'mesa'
        ...
        {/* Lado derecho: Botón flotante/resumen del carrito */}
